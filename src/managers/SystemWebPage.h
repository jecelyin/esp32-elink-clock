...
<script>
  const state={todos:[],alarms:[],ringtones:[{value:"spiffs:/alarm.wav",label:"经典闹铃",builtin:true}],radio:null,path:"/"};
  ...
  function addAlarm(){state.alarms.push({h:7,m:30,e:true,r:0,w:127,s:state.ringtones[0].value});renderAlarms()}
